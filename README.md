...
This repository contains Java practice projects focusing on backend development.  
...
- **Day-07_Threads_Concurrency**: Java multithreading basics including Thread class, Runnable interface, lifecycle, and synchronization.
- **Day-08_Collections_Framework**: Core Java Collections including List, Set, HashSet, ArrayList, and HashMap with data storage and iteration.
